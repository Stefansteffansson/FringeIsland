...
- **Roadmap:** `docs/old_products/ferd/planning/ROADMAP.md`
...
- **Session history:** `docs/old_products/ferd/sessions/`
...
- docs/old_products/ferd/planning/ROADMAP.md → Wave completion, next priorities
...
1. Read `docs/old_products/ferd/development/agents/learnings/[domain].md`
2. For each entry:
...
**Full workflow:** `docs/old_products/ferd/development/DOC_HEALTH_CHECK.md`
...
2. **Schema drift:** Were any tables added, columns dropped, or RLS policies changed? → If yes: check `docs/old_implementation/shared/SCHEMA_OVERVIEW.md`, `docs/old_implementation/shared/RLS_POLICIES.md`, and `docs/old_implementation/shared/DATABASE_CURRENT.md` for accuracy.
...
- `docs/old_products/ferd/planning/ROADMAP.md` — Update if wave progress changed
- `CHANGELOG.md` — Update if version bumped
- Create session bridge in `docs/old_products/ferd/sessions/` if significant work
...
1. Check `docs/old_products/ferd/planning/DEFERRED.md` — Already deferred?
2. Check `docs/old_products/ferd/specification/PRODUCT_SPEC.md` — In scope for current wave?
...
1. Check `docs/old_products/ferd/development/agents/learnings/sprints.md` for process insights
2. During retrospectives, capture process improvements
3. At close-down, update MEMORY.md if process rules changed

Journal location: `docs/old_products/ferd/development/agents/learnings/sprints.md`
...
- **Feature development workflow:** `docs/old_products/ferd/development/WORKFLOW.md`
