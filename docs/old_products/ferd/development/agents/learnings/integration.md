...
**Promotion:** Confirmed patterns → `docs/old_products/ferd/development/agents/contexts/integration-agent.md` (playbook)
...
- Update ALL related state after role changes (members + userRoles + userPermissions)
