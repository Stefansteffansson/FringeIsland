...
**Related:** [Group Management](./FR-group-management.md) | [Foundation Schema](./AR-foundation-schema.md) | [Leave Group Review](./_archive/2026-02-27-leave-group-feature-review.md)
...
> These types are also registered in the [Notification System — Sprint 2 Types](./FR-notification-system.md).
...
- `docs/old_products/ferd/development/specs/groups.md` — B-GRP-008 (Regular Leave), B-GRP-009 (DeusEx Handover), B-GRP-010 (Group Closure)
...
| `docs/old_products/ferd/development/specs/groups.md` | B-GRP-008, B-GRP-009, B-GRP-010 |
...
2. ~~**No Track 1 (stewardship nomination)**~~ — **RESOLVED (v0.2.35, Sprint 3).** `nominate_steward()` RPC, smart notifications with Accept/Decline, sequential nominees, 7-day expiry, DeusEx fallback. See [smart-notifications.md](./AR-smart-notifications.md).
3. ~~**No platform exit**~~ — **RESOLVED (v0.2.36, Sprint 4).** `admin_exit_user_from_platform()` RPC cascades leave across all engagement groups (L1/L2/L3 per group), decommissions user, force-logs-out. See [platform-exit.md](./FR-platform-exit.md).
...
- ~~Track 1 stewardship nomination flow~~ — **IMPLEMENTED (v0.2.35, Sprint 3).** See [smart-notifications.md](./AR-smart-notifications.md).
...
- **v0.2.36** (2026-02-28): Platform exit implemented in Sprint 4 — `admin_exit_user_from_platform()` RPC cascades L1/L2/L3 across all engagement groups, decommissions user, force-logs-out. Known Limitation #3 resolved. See [platform-exit.md](./FR-platform-exit.md).
- **v0.2.35** (2026-02-28): Track 1 stewardship nomination implemented in Sprint 3 — `nominate_steward()` RPC, smart notifications, sequential nominees, DeusEx fallback. Known Limitation #2 resolved. See [smart-notifications.md](./AR-smart-notifications.md).
