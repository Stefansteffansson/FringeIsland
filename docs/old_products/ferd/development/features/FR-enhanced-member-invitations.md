...
- **B-GRP-006:** User Search Typeahead — `docs/old_products/ferd/development/specs/groups.md`
- **B-INV-001:** Pending Email Invitations — `docs/old_products/ferd/development/specs/invitations.md`
...
| File | Purpose |
|------|---------|
| `docs/old_products/ferd/development/features/FR-enhanced-member-invitations.md` | This feature doc |
| `docs/old_products/ferd/development/specs/invitations.md` | B-INV-001 behavior spec |
...
See `docs/old_products/ferd/development/features/FR-leave-group-core.md` for full details.
...
| `docs/old_products/ferd/development/specs/groups.md` | Add B-GRP-006 |
