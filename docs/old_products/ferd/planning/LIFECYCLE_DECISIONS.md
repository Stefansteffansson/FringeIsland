...
**Status: Wave TBD — pending work package redistribution (see WAVE_REDISTRIBUTION.md). Does NOT block leave-group (limited to personal-groups-leaving-engagement-groups).**
...
**When:** Wave TBD — pending work package redistribution (see WAVE_REDISTRIBUTION.md).
