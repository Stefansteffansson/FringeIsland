...
- **Mists before FIMs (where applicable).** Anonymous sessions are first-class (ADR-U004; the anonymous entrant is canonically the **Mist** — see the bible's roles and governance chapter). If a feature can be offered to Mists meaningfully, design for Mists first and let FIMs inherit; don't gate everything behind transcendence (sign-up).
