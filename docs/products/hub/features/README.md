...
| [FEAT-H012](./FEAT-H012-per-device-sessions.md) | Per-device sessions — see every signed-in device, sign one out, and the device finds out fast (IDN-11) | Ferd | 4-ready | none |
