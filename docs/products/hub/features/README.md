...
| [FEAT-H008](./FEAT-H008-render-consent-state.md) | Render consent state — show the FIM their own consent decisions and history (IDN-6) | Ferd | 4-ready | none |
| [FEAT-H009](./FEAT-H009-update-consent-decisions.md) | Update consent decisions — grant/withdraw granular consent; sharing controls split out (IDN-7 consent half) | Ferd | 4-ready | none |
