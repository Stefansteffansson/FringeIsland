...
| [FEAT-H006](./FEAT-H006-render-account-state.md) | Render account state — show the FIM whether their account is active, deactivated, or decommissioned (IDN-9) | Ferd | 4-ready | none |
| [FEAT-H007](./FEAT-H007-self-service-account-reactivation.md) | Self-service account reactivation — the FIM reactivates their own deactivated account (IDN-12) | Ferd | 4-ready | none |
