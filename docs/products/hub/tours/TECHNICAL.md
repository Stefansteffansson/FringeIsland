...
The Hub provides each FIM — visitor or member — with a stable, persistent identity, a soft conversion path between visitor and member, and a private workspace for reflection that no one but the member can see.

### Capabilities

| ID | Capability | FC | Founding Q |
|----|------------|----|-----------:|
| IDN-1 | Anonymous visitor identity on arrival | Partial-Ferd | WAI |
| IDN-2 | Convert visitor to authenticated FIM identity | Partial-Ferd | WAI · WDIW |
...
- **DS-3 Experience** in IDN-2 and IDN-10 — visitor→FIM conversion carries in-flight enrolments forward; deletion freezes them.
...
| JRN-5 | Preserve in-flight enrolment across visitor→FIM conversion | Partial-Ferd | HDGT |
