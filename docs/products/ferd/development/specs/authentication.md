...
- [ ] Inactive users redirected to account reactivation page (deferred — Wave TBD — pending redistribution (see WAVE_REDISTRIBUTION.md))
...
**Status:** ✅ IMPLEMENTED (v0.2.12) — reactivation page deferred to Wave TBD — pending redistribution (see WAVE_REDISTRIBUTION.md)
...
- B-AUTH-008: OAuth Integration (deferred to Wave TBD — pending redistribution (see WAVE_REDISTRIBUTION.md))
