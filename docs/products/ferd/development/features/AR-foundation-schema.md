...
**Related:** [Group Management](./FR-group-management.md) | [Leave Group Core](./FR-leave-group-core.md) | [Platform Exit](./FR-platform-exit.md) | [Leave Group Review](./_archive/2026-02-27-leave-group-feature-review.md) | [Journey System](./FR-journey-system.md)
...
- ~~Leave-group feature~~ — **IMPLEMENTED (Sprint 2, v0.2.34).** See [leave-group-core.md](./FR-leave-group-core.md).
- ~~Smart notifications~~ — **IMPLEMENTED (Sprint 3, v0.2.35).** See [smart-notifications.md](./AR-smart-notifications.md).
