...
- [Notification System](./FR-notification-system.md) — Notification integration pattern
- [Group Forum System](./FR-group-forum-system.md) — Similar messaging patterns (threading, RLS)
- [Dynamic Permissions System](./AR-dynamic-permissions-system.md) — D13: messaging as RBAC infrastructure
- [Communication Behaviors](../specs/communication.md) — Existing B-COMM specs
