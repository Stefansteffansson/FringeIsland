...
- **The parent writes to no Domain Service.** Each child writes to exactly one (World Studio → DS-1 World Model; Arc Studio → DS-2 Narrative; Journey Studio → DS-3 Journeys), per the studios-tier file.
