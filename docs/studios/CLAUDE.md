...
- **Studios:** [`universe-studio/`](./universe-studio/) (parent: umbrella + binding frame) containing [`world-studio/`](./universe-studio/world-studio/) (writes to World Model), [`arc-studio/`](./universe-studio/arc-studio/) (writes to Narrative, Urd) and [`journey-studio/`](./universe-studio/journey-studio/) (writes to Experience Engine, Eid+).
