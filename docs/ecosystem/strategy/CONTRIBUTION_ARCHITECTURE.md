...
Dreamineer authority is granted via group and role permissions; how a FIM acquires it — earned, granted, or applied for — is an open thread in the [roles core](../universe/roles/README.md).
...
- **The governance structure** — the Foundation as legal holder and the enterprise-stewardship plane (the Universeers, the FringeIsland Council, DeusEx) are permanently protected
