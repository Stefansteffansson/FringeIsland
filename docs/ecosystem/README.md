...
**This is NOT for:** The universe design itself, the discovery sessions, research reports, or the open-questions register — those live one level up in [`../fringeisland-thinking/`](../fringeisland-thinking/README.md), one flat folder where the filename carries the register (`bible--`, `discovery--`, `research--`, `record--`, `questions--`, `quotes--`). Also not for technical architecture and binding decisions (→ `docs/architecture/`), service or product descriptions (→ `docs/platform/`, `docs/products/`), or operational planning (→ `docs/planning/`).
...
3. [`../fringeisland-thinking/bible--fringeisland-universe.md`](../fringeisland-thinking/bible--fringeisland-universe.md) — the Universe Bible: what the world is and how it works
...
- When a discovery concept matures into universe design (how the world works) → it is baked into the Universe Bible, [`bible--fringeisland-universe.md`](../fringeisland-thinking/bible--fringeisland-universe.md), from the session's "Baked into the bible" list
...
- `../fringeisland-thinking/bible--fringeisland-universe.md` **imagines** — it says how the world actually works
