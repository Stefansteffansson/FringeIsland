...
**Connection to G-29:** G-29 covers the routing mechanism for cross-entity findings; G-31 covers naming their producer. Resolutions are complementary; either can land first. G-31 lands in cascade-plan Session 1 (this commit); G-29's resolution session is deferred until the next per-entity L3 derivation with stress-test pass produces the second instance of cross-entity findings against which to design the routing mechanism. Cascade-plan Session 4 was initially expected to supply that instance but the 2026-05-03 audit verified work-shape mismatch — see G-29's body for the correction.
