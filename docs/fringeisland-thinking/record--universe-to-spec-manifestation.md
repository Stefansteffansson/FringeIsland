...
> **Written against the canon files, which were deleted on 2026-09-26 when the Universe Bible (`bible--fringeisland-universe.md`) became the single truth.** The canon file names below are the record of what this snapshot measured; the bible's chapters carry the same content (cosmology → 2, roles → 6, beings → 3, narrative → 5, growth and privacy → 4, community → 7). The next run of this map is against the bible.
