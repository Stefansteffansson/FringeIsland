...
## `canon--*` (the former `docs/ecosystem/universe/`) — the canonical world
...
### Beings — `canon--beings--whisp-and-npcs.md`
...
### Kickstarter — `canon--community--kickstarter-season-zero.md`
...
## `discovery--*` / `questions--*` (the former `docs/ecosystem/thinking/`) — working ideas
...
### `discovery--*` (Session 01, the portal-ideas note, the tracker; the onboarding summary was retired 2026-09-16)
