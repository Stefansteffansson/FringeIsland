...
- The Three Worlds beyond the Ordinary World — Safe Harbour and Other Side have not been touched in this session. The Ordinary World is now framed both as "our 24/7" and as the substrate the FringeIsland reality overlays onto.  **[STILL OPEN -> reconciliation deferred to graduation per Statement 26]**
- Shadows — anonymous entrants to the universe. Not yet explored.  **[RESOLVED -> Statement 16]**
- The relationship between the Whisp and the other Whisps / between FIMs and FIMs — not yet explored.  **[PARTIAL -> Statements 36, 27, 35 | open: FIM<->FIM bond = the branch (S36), cord-healing (S27); Whisp-to-Whisp perception still open (see 1403)]**
- How the Whisp's "questions to the human" actually surface in experience — mechanism not yet defined.  **[PARTIAL -> Statements 17, 18 | open: assessment dissolved into Whisp-led curious dialogue, distributed over time; exact experiential surfacing not fully specced]**
- The relationship between the Whisp and the flourishing dimensions (does the Whisp probe each? hold them silently? surface them when relevant?) — not yet defined.  **[PARTIAL -> Statement 28 | open: Whisp senses the starved drive and leans toward balance (S28 dance-partner); relation to full flourishing dimensions not fully defined]**
- The nature of FringeIsland-world artifacts — what kinds of things appear in the overlay? Who places them? Are they universal (every FIM sees the same artifact at the same field) or personal (each FIM's overlay is unique to them)? Mixed?  **[PARTIAL -> Statements 13, 35 | open: Dreamineers/Creators place artifacts (S13); single shared accreted world leans universal (S35); artifact-level universal/personal not fully locked]**
- The Hub's role — if the Gimbal is the mobile AR lens, what is the Hub (web, FIM-facing) in this parallel-world framing? Same world, different vantage? A different mode of seeing?  **[STILL OPEN]**
- Interaction with FringeIsland-world artifacts — "see and interact with" was used. The interaction modality is not yet defined.  **[PARTIAL -> Statements 32, 34, 27 | open: interaction modalities now exist: heal coupled cause (S32), tend/garden (S34), anchor cord to objects (S27); full modality spec open]**
- Whether the Whisp can perceive the FringeIsland layer without the Gimbal — i.e., does internalisation eventually include AR perception, or only the inner-voice function?  **[STILL OPEN]**
- The nature of the beyond-register — is it a single coherent place, multiple distinct places, an open expanse, a topology of its own? Unknown.  **[RESOLVED -> Statements 31, 26]**
- The thresholds themselves — are doors / passages / rabbit holes location-anchored in the ordinary world (e.g., this specific field has a door)? Or are they discovered through Gimbal perception in arbitrary locations? Or both?  **[PARTIAL -> Statements 26, 31, 33 | open: home portal travels with the FIM (S33), Tree portal fixed (S26), reached through Shimmer+portals (S31); general location-anchored-vs-discovered rule not fully locked]**
- Whether passage through a threshold requires conditions — readiness, invitation, the Whisp's state, something else.  **[PARTIAL -> Statements 26, 33 | open: invitation/permission for private places (S26); home portal unconditional (S33); narrative-threshold readiness conditions still open]**
- Whether shadows and FIMs have the same access to the beyond-register, or whether identity matters at the threshold.  **[PARTIAL -> Statement 16 | open: Shadows have limited abilities so probably not full access; exact line deferred]**
- How the beyond-register relates to earlier universe concepts like Safe Harbour and Other Side — are these the beyond-register? Subregions of it? Something else?  **[STILL OPEN -> reconciliation deferred to graduation per Statement 26]**
- How tonal range is distributed across the topology — is the overlaid register more weighted toward warmth and the beyond-register toward danger? Or are both registers full-spectrum? Or does the spectrum map to something else entirely (story location, FIM readiness, narrative phase)?  **[RESOLVED -> Statements 31, 32]**
- Who authors the narratives that play out across this tonal landscape — the platform? FIMs themselves? Whisps? A mix? (Partially answered by Statement 13: Dreamineers in Arc Studio author narratives. Whether all narratives are FIM-authored, or whether platform-authored content also exists, is still open.)  **[PARTIAL -> Statements 13, 29, 24 | open: narratives authored by Tellers/Dreamineers in Arc Studio (S13,29), AI-assisted human-last-say (S24); platform-vs-FIM-authored mix not fully closed]**
- How "life and death" actually manifests — narrative deaths inside stories? Mortality of FringeIsland-world beings? Symbolic stakes? Something else?  **[RESOLVED -> Statements 19, 22, 27]**
- Whether the Whisp can be harmed, lost, or threatened by the hostile pole of the world, or whether it is structurally protected.  **[RESOLVED -> Statements 27, 22]**
- The distinction between Dreamineers and Creators — are these two different roles, two names for the same role, or overlapping roles with different emphases?  **[RESOLVED -> Statement 29]**
- How a FIM becomes a Dreamineer or Creator — self-selection? Invitation? Maturity gate?  **[PARTIAL -> Statement 29 | open: becoming a Dreamineer is permission/role-gated (S29 mechanism); the acquisition route (earned/granted/applied) explicitly undefined (see 1452)]**
- How AI is used inside each studio while preserving the human-first principle — unspecified.  **[PARTIAL -> Statement 24 | open: AI-as-extension model, dreaming sessions, three-stage human-first, guard railing (S24); per-studio operational specifics still emerging]**
- How "individual contributions" are protected technically and culturally — attribution, authorship, withdrawal?  **[PARTIAL -> Statements 13, 24 | open: principle that individual contributions are protected affirmed (S13,24); technical/cultural attribution/withdrawal mechanisms open]**
- The relationship between Journey Studio's three modes (alone / pairs / group) and the Three Perspectives meta-lens — are they the same thing, or related but distinct?  **[RESOLVED -> Statement 13]**
- Whether World Studio, Arc Studio, and Journey Studio are tools for Dreamineers/Creators, products in their own right, or both.  **[PARTIAL -> Statements 29, 30 | open: Studios framed as authorial workbenches gated by Dreamineer permissions (S29,30); products-in-their-own-right angle not closed]**
- The origin and authorship of NPCs — are they crafted in Arc Studio (story characters), World Studio (world inhabitants), both, or something else?  **[RESOLVED -> Statement 30]**
- Whether NPCs have any analogue to the Whisp — an inner instrument — or whether they are categorically different from FIMs at the level of being.  **[PARTIAL -> Statement 30 | open: NPCs defined as authored layered composites (no Whisp implied -> leans categorically different); not explicitly stated]**
- Whether NPCs can be AI-driven, scripted, hybrid, or all of the above. Given the AI-first principle (Statement 13), AI-driven NPCs are plausible but not yet stated.  **[PARTIAL -> Statement 24 | open: AI can produce NPC voices/content (S24) -> AI-driven plausible/supported; scripted/hybrid drive-mode not locked]**
- Whether NPCs persist across narrative arcs / seasons / episodes, or whether some are scoped to a single story.  **[PARTIAL -> Statement 30 | open: world-inhabitant NPCs (body+culture) persist as standing texture; story-critical (Teller) may be story-scoped - implied by the layered model]**
- How NPCs distribute across the topology — overlaid register, beyond register, both? Some only in certain places?  **[PARTIAL -> Statement 32 | open: place-3 near-side NPCs evidenced (the androids, S32); a full topological distribution rule not given - thin]**
- Whether NPCs are universal (every FIM encounters the same NPC at the same place) or contextual to a FIM's journey.  **[PARTIAL -> Statements 35, 30 | open: world-substrate NPCs universal-leaning (single shared world, S35); story-critical NPCs contextual to a Teller's story (S30)]**
- The exact scope of Shadow limitations — explicitly deferred per Statement 16. Which abilities are gated, which are open, and on what axis (perception, interaction, persistence, social) is unknown.  **[STILL OPEN -> deferred per Statement 16]**
- Whether Shadows have any access to a Whisp — a proto-Whisp during the session, a Whisp that begins to form, or no Whisp at all until transcendence. Unknown.  **[STILL OPEN]**
- The mechanism of transcendence — what "transferred into their FIM character" actually entails technically and experientially. Session state, Whisp seed (if any), narrative progress, relationships with NPCs, items? All? Some?  **[STILL OPEN]**
- Whether a Shadow can be perceived by FIMs and NPCs in the world, or whether Shadows are themselves shadowy / partially-present to other beings.  **[STILL OPEN]**
- How long a Shadow session can persist — single visit, browser session, weeks, indefinitely? And how state persists for an unregistered being.  **[STILL OPEN]**
- Whether the "limited abilities" of a Shadow are a feature gate or a narrative truth (i.e., Shadows literally cannot do certain things in-world because they are Shadows, not because the platform restricts them).  **[STILL OPEN]**
- Which other assessments alongside Big 5 will be used — the "et al." is open.  **[PARTIAL -> Statements 9, 19, 28 | open: candidates now named: ITC (S9), multi-instrument confirmed (S19), SDT/PERMA+/VIA/flourishing dims (S28); final selection still open (overlaps 1384,1447)]**
- How the Whisp distributes assessment items over time without losing structural validity — e.g., does Big 5 still measure what it measures if its items arrive embedded in months of dialogue with the Whisp's own framing?  **[STILL OPEN]**
- What "Whisp quality" specifically modulates — perception of FringeIsland artifacts? Quality of dialogue? Access to journeys, narratives, or beyond-register places? All of the above?  **[PARTIAL -> Statements 17, 18, 26 | open: quality modulates perception/mediation (S17,18) and Shimmer clarity (S26); access-to-journeys/places not fully specced]**
- Whether the Whisp's quality is a single scalar, a multi-dimensional state, or a continuous experience without explicit measurement.  **[PARTIAL -> Statement 18 | open: five-trait/five-sense structure implies multi-dimensional acuity; single-scalar-vs-multi-dim and explicit-measurement not locked]**
- How the FIM perceives the Whisp's quality changing — felt sense only, explicit feedback, both?  **[PARTIAL -> Statements 17, 18 | open: leans felt-sense via world-availability and Whisp attunement (S17 obs, S18); explicit-feedback not closed]**
- Whether self-disclosure to the Whisp ever has diminishing or negative returns (e.g., over-disclosure, performative disclosure).  **[STILL OPEN]**
- The relationship between the Whisp's quality and the Whisp's contents — same axis, correlated axes, or independent?  **[STILL OPEN]**
- The specific Big-5-to-sense mapping (Openness, Conscientiousness, Extraversion, Agreeableness, Neuroticism ↔ sight, hearing, smell, taste, touch — in some order). Whether to lock the mapping early or let it emerge.  **[STILL OPEN]**
- Whether the sense-trait coupling is binary (have it or don't) or gradient (acuity scales with Whisp quality in that trait). The gradient reading aligns with Statement 17.  **[PARTIAL -> Statements 18, 17 | open: gradient (acuity) reading favoured (S18, aligns S17); binary-vs-gradient not locked]**
- How accessibility / disability in the ordinary world interacts with the five-senses framing — does the FringeIsland sensorium adapt to the FIM's lived sensorium, or preserve five senses metaphorically?  **[STILL OPEN]**
- What it actually means, perceptually, for a FringeIsland scene to "require" a sense — are AR overlays muted/missing/distorted when the corresponding sense is under-developed?  **[PARTIAL -> Statements 18, 26 | open: under-developed sense -> partial perception (S18); perception scales with Whisp development through the Shimmer (S26); exact rendering not specced]**
- Whether the five senses framing applies only to the overlaid register, only to the beyond register, or both.  **[PARTIAL -> Statement 26 | open: near-side perception is development/sense-gated (S26); whether five-senses applies to the Beyond not addressed - thin]**
- How Dreamineers / Creators design content against the five-sense requirement — is sensory layering a craft discipline inside Universe Studio?  **[STILL OPEN]**
- Whether other Whisp-fillers (beyond Big 5) also map to senses or to something else entirely.  **[STILL OPEN]**
- The phenomenology of in-narrative death and rewind — how it actually feels to the FIM. Avoiding both clinical numbness and traumatic intensity.  **[STILL OPEN]**
- Whether the rewind is FIM-initiated, Whisp-offered, or both — and what governs the choice.  **[STILL OPEN]**
- What state persists across rewind: story state (resets), FIM awareness (presumably persists), Whisp memory of the failed run (presumably persists), growth from the attempt (presumably persists). Needs explicit definition.  **[PARTIAL -> Statements 27, 19, 20 | open: story-state persistence via anchor fallback (S27); awareness/Whisp-memory/growth persist, varies per story (S19,20)]**
- Group respawn coordination: when a collective experiences a story and members disagree on whether to rewind, what happens?  **[PARTIAL -> Statements 20, 21 | open: round-bounded resolves the synchronized case (S20); non-round-bounded disagreement still open (see 1397)]**
- Whether the comfort/growth/panic gradient is read by the Whisp from the FIM's behaviour, biometrics (if any), explicit signals, all of the above?  **[STILL OPEN]**
...
- Whether the five-senses metaphor anchors to Big 5 specifically or moves up to a more general frame (e.g., the five flourishing dimensions) as more instruments come online.  **[STILL OPEN]**
- Which respawn topologies FringeIsland implements: event-local, round-bounded, day-bounded, episode-bounded, others? Likely several.  **[PARTIAL -> Statements 20, 21, 27 | open: plural respawn topologies confirmed and modeled (S20,21) incl. cord two-tier (S27); exact implemented set is a build decision]**
- Whether trained loops (FIM knowingly enters a repeating story) and discovered loops (FIM realises mid-story that they are in a loop) are both supported — and whether the distinction is surfaced to the FIM or held implicit.  **[STILL OPEN]**
- How the loop's unit (death, round, day, episode) is communicated to the FIM — explicit countdown, dramatic cues, learned through play?  **[STILL OPEN]**
- What persists across each respawn topology — likely varies per topology and per story, not a global rule.  **[RESOLVED -> Statement 20]**
- Whether Dreamineers select the loop texture (combat practice / mystery / inquiry / reflective) as part of story design, and whether the texture maps to specific developmental purposes.  **[PARTIAL -> Statements 20, 29 | open: story authors lean stories into different loop textures (S20) via Arc Studio Tellers (S29); developmental-purpose mapping suggested not locked]**
- How shared groups handle individual readiness for retry vs. group readiness in a non-round-bounded story.  **[STILL OPEN]**
- Whether the loop's framing is itself a developmental signal (e.g., a FIM whose Whisp is in early stages encounters trained loops with clear rules; a more developed FIM is offered discovered loops where the loop's nature is itself the puzzle).  **[STILL OPEN]**
- What home base actually is, as a worldbuilding object — physical place, symbolic anchor, relational location, or all of the above depending on story.  **[PARTIAL -> Statements 26, 33, 34 | open: the FIM's persistent home/safe-harbor richly defined (S26,33,34); whether journey-scoped respawn home base is the same object still open (see 1394)]**
- Whether each FIM has a single persistent home in FringeIsland and how that relates to journey-scoped home bases inside episodes.  **[PARTIAL -> Statements 26, 33 | open: single persistent home confirmed and made always-accessible via the home portal (S26,33); relation to episode-scoped home base still open]**
- How nested respawn levels are surfaced to the FIM — does the FIM know they can also episode-repeat, or only home-base respawn? Is this part of how a story is set up?  **[STILL OPEN]**
- Whether the Whisp's behaviour at home base differs from its behaviour mid-story (e.g., home base as the place of reflection between attempts).  **[STILL OPEN]**
- How non-Counter-Strike-style group respawn works for slower, longer FringeIsland episodes — voting? Waiting for all to be ready? Whisp-mediated coordination?  **[STILL OPEN]**
- Whether respawn cost (e.g., something is lost at each respawn) is part of any of these modes, or whether all respawns are cost-free.  **[PARTIAL -> Statement 27 | open: the cord/anchor model introduces real cost - fallback to last anchor or full restart (S27); whether other modes carry cost not fully specced]**
- Whether "failure" is the only trigger for respawn, or whether the FIM can also choose to respawn deliberately (e.g., to try a different approach in a discovered-loop story).  **[STILL OPEN]**
- Whether the Whisp's continuity across respawn is itself a phenomenologically distinct experience (the Whisp "remembers" the prior run, the FIM remembers it through the Whisp's memory, or both).  **[PARTIAL -> Statements 22, 27 | open: continuity structure defined - FIM constant, Whisp re-enters (S22,27); phenomenological distinctness still open (see 1380,1379)]**
- Whether the Whisp can experience emotions like Jake's Avatar does — fear in danger, joy in arrival — and whether those emotions transmit to the FIM through the Gimbal.  **[STILL OPEN]**
- How visible the Whisp's body / form is to the FIM — does the FIM see a third-person Whisp-figure, or experience FringeIsland in first person through the Whisp's perception?  **[PARTIAL -> Statement 27 | open: experiential co-presence leans first-person/accompanying (S27); third-vs-first-person Whisp form not locked]**
- Whether multiple Whisps of multiple FIMs can perceive each other in FringeIsland, and what that looks like (Avatar shows Avatars seeing other Avatars; can Whisps see other Whisps?).  **[PARTIAL -> Statements 27, 36 | open: mutual cord-healing (S27) and FIM-FIM branches (S36) imply mutual perception; the visual what-it-looks-like still open]**
- Whether the Avatar metaphor changes how Shadows are understood (a Shadow may be a being without a fully-formed Avatar; or it may be a Jake without yet having an Avatar at all).  **[STILL OPEN]**
- Which ARG mechanics FringeIsland actually adopts: location-anchored clues, collaborative puzzle-solving, real-world artifacts, distributed-media storytelling, in-fiction characters that respond in real time?  **[PARTIAL -> Statement 24 | open: capability to deliver ARG-style real-world-threaded mechanics affirmed (S24); the specific adopted mechanic set still open]**
- Whether "Alternative Reality" becomes the canonical name for the FringeIsland-world layer, or stays a design-lineage reference distinct from the universe's internal vocabulary (parallel reality, overlay, beyond register).  **[RESOLVED -> Statement 26]**
- How to preserve reality-fiction blur without ever deceiving the FIM in a harmful way — the line between immersive ambiguity and genuine confusion, especially given meta-safety and voluntariness.  **[PARTIAL -> Statements 19, 24 | open: guard-railing (AI catches harmful 'genuinely frightening' drift) + meta-safety (S19,24) provide the mechanism; the precise line is a design discipline]**
- Whether collective ARG-style mysteries are an ecosystem-wide layer (all FIMs solving something together) or scoped to specific journeys/seasons.  **[STILL OPEN]**
- Whether NPCs (Statement 15) can serve as the in-fiction "characters who respond" that the authored ARGs used to such effect (the Operator, the Sleeping Princess in I Love Bees).  **[PARTIAL -> Statements 24, 30 | open: story-critical NPCs with character layer (S30) + AI-driven voices (S24) can serve as responsive ARG-style characters; not explicitly tied to ARG design]**
- How dreaming sessions are actually run — solo Dreamineer, group, FIM-facing? Tooling? Where in Universe Studio do they live?  **[PARTIAL -> Statements 24, 29 | open: dreaming sessions defined in purpose and ownership - Dreamineers run them (S24,29); operational how/where in Universe Studio still open]**
- Where the line sits between AI-as-facilitator and AI-as-generator inside a dreaming session — can AI ask questions without its questions themselves anchoring the human?  **[PARTIAL -> Statement 24 | open: the facilitator-not-generator line is drawn for Stage-1 dreaming sessions (S24); the question-anchoring nuance remains a flagged concern]**
- Who authors guard rails, at what level (ecosystem-wide constitutional rails vs. per-story rails vs. per-Dreamineer rails), and how they are versioned and enforced.  **[PARTIAL -> Statement 24 | open: guard rails are human-authored Stage-1 artifacts (S24); the levels (ecosystem/per-story/per-Dreamineer) and versioning/enforcement still open]**
- How the second kind of guard rail (AI catching the human) is surfaced without becoming nannying or undermining the human's authority — tone, frequency, dismissability.  **[PARTIAL -> Statement 24 | open: concept and stance defined with examples and dismissability (S24); tone/frequency design specifics remain]**
- Whether guard rails are themselves subject to the stage model (human dreams the rails, AI expands rail options, human selects) — i.e. the rails are authored by the same process they govern.  **[PARTIAL -> Statement 24 | open: rails are Stage-1 human-authored (S24); whether they recursively use the full stage model not explicitly locked]**
- How "integrate with real-world happenings" is bounded by safety (physical safety of FIMs sent to real places; reality-fiction blur not curdling into genuine fear or confusion; privacy of real-world data feeding the experience).  **[PARTIAL -> Statement 24 | open: safety-bounding via guard rails incl. physical-location flags and privacy (S24); specifics open]**
- Whether the stage model (human-first → AI expansion → human last say) is specific to creation/authoring, or also describes the FIM's own in-world experience with their Whisp.  **[PARTIAL -> Statements 24, 29 | open: stage model framed as authorial (S24,29); the in-world Whisp experience is a distinct structure (S5,17,18) - separation implied not stated]**
- Whether FringeIsland's aesthetic lineage is deliberately Nordic / uncanny-in-the-everyday (Akerman, Stalenhag), or whether that is one influence among many.  **[PARTIAL -> Statement 25 | open: Nordic / uncanny-in-the-everyday lineage strongly indicated (Akerman+Stalenhag, S25); not locked as exclusive]**
- Whether a single Dreamineer can/should author a whole coherent world (Akerman model) or whether FringeIsland worlds are inherently collaborative — and how the quality bar set by single-author worlds is met collaboratively.  **[PARTIAL -> Statements 25, 35, 13 | open: FringeIsland's world is collaborative/shared (S35,13); single-author coherence is an aspirational quality bar (S25); how the bar is met collaboratively remains open]**
...
- How "creation as discovery" (the worldbuilder finding their own world) might be designed for, not just hoped for, inside Universe Studio.  **[STILL OPEN]**
- Whether FringeIsland (the island) sits in the Fringe's near side or in the Beyond — explicitly deferred in Statement 26.  **[RESOLVED -> Statement 33]**
- What "the Void" is — reserved in Statement 26, to be outlined soon. Whether it sits within the topology (e.g. a region of the Beyond) or on a different axis entirely.  **[RESOLVED -> Statements 27, 35]**
- How one skims/searches the glowing glass balls on the Tree to find or identify friends.  **[STILL OPEN]**
- How one actually travels *through* a glass ball into a FIM's private place.  **[PARTIAL -> Statement 33 | open: own-home travel via the always-present home portal (S33); travel through another FIM's ball (visiting) still open]**
- The fuller definition of a private place — what it contains, how it is shaped, what a FIM can build/grow/keep there, and how the granular visit/access permissions work in practice.  **[PARTIAL -> Statements 26, 33, 34, 35 | open: private place substantially fleshed out: a tendable, inviolable home/garden behind the home portal (S26,33,34,35); granular-permission mechanics 'in practice' still open]**
- Whether the Shimmer is uniform or varies (places where it is thinner/thicker, clearer/murkier) and whether Dreamineers can shape it.  **[PARTIAL -> Statement 26 | open: perception clarity through the Shimmer varies with Whisp development (S26); place-variance of the Shimmer and Dreamineer-shaping of it still open]**
- How the spatial comfort/growth/panic gradient is actually rendered — is "distance from FringeIsland" literal travel distance in the Fringe, narrative distance, or felt distance?  **[RESOLVED -> Statement 27]**
- Reconciliation: whether today's "safe harbor" is the existing cosmology's "Safe Harbour," and how the Fringe near-side/Beyond maps onto the existing "Other Side" and "the Void." (Decision deferred to graduation.)  **[STILL OPEN -> reconciliation deferred to graduation per Statement 26]**
- Whether "home" (private place) and "safe harbor" (collective island) need fully distinct names before graduation, or whether the collective/private context keeps them clear.  **[PARTIAL -> Statements 26, 34 | open: the conceptual distinction is sharpened - home=inviolable ball vs tendable commons (S26,34); the naming decision itself remains for graduation]**
- Whether each FIM's private place is *in* collective FringeIsland (a house in the village) or *reached from* it via the Tree (a separate pocket-space behind the glass ball) — the Tree-as-portal framing suggests the latter, but this is not yet locked.  **[RESOLVED -> Statements 33, 35]**
- Which objects can serve as valid cord anchor points (Statement 27) — explicitly deferred.  **[STILL OPEN -> deferred per Statement 27]**
- What can *cut* the cord — hostile actors (NPCs? other FIMs?), environmental hazards, venturing too far, time, the FIM's own choices? The threat model for severance is undefined.  **[RESOLVED -> Statements 27, 35, 32]**
- How cord-healing between FIMs works mechanically — proximity, deliberate action, a shared ritual, the Whisps cooperating? And whether a FIM can heal a stranger's cord or only an invited/known FIM's.  **[PARTIAL -> Statements 36, 27 | open: mechanism = healing runs along grown branches (S36); stranger-vs-known resolved -> must share a branch; finer mechanics (proximity/ritual) still open]**
- How the cord is kept meaningful early yet non-distracting later — and whether its fading visibility is a deliberate internalisation/graduation signal (Statements 6–7) rather than only a UX concession.  **[PARTIAL -> Statement 27 | open: the fading-visibility-as-internalisation-signal reading is advanced as a held possibility (S27 obs, ties S6-7); not locked]**
- Whether anchor-object density is a deliberate difficulty lever (sparse = committing/risky, rich = forgiving) that Dreamineers tune, like protection on a climbing route.  **[PARTIAL -> Statement 27 | open: advanced as a candidate difficulty lever (S27 obs); not yet locked]**
- What "the Whisp suffers" looks like short of death — degraded quality, lost contents, pain, partial memory loss? The gradient between a strained cord and a cut one.  **[STILL OPEN]**
- How a severed/recovering Whisp relates to the Statement-17 "Whisp quality / contents" — does severance cost disclosure-progress, or only journey-progress?  **[STILL OPEN]**
- Whether the Beyond, being uncoordinated, still requires the FIM's body to be *somewhere* in the Ordinary World (just no longer governing the view), or whether deep-Beyond journeys change the FIM's bodily situation (e.g. needing stillness/safety like the lying bodies in the reference images).  **[RESOLVED -> Statement 27]**
...
- Whether the Void itself contains anything (is it empty transit, or are there things *in* the Void between anchors?), and whether the Void is ever a place of encounter rather than only of exposure.  **[RESOLVED -> Statements 35, 32]**
- Whether Live / Grow / Matter are held in simultaneous *balance* or as a developmental *sequence* (Statement 28) — explicitly deferred; affects how the Whisp works with them.  **[RESOLVED -> Statement 28]**
- How the Whisp actually works *with* Live / Grow / Matter — does it sense which drive is starved and orient journeys toward it? Are the three legible to the FIM, or only felt?  **[PARTIAL -> Statement 28 | open: the Whisp senses the starved drive and orients toward balance (S28); legible-to-FIM-vs-only-felt still open (see 1446)]**
- Whether each of the three drives has a recognisable *negative pole* the universe must handle with care (Live → numbness/avoidance; Grow → stagnation or grind; Matter → meaninglessness) and how the Whisp responds at each.  **[RESOLVED -> Statement 28]**
- How the external pole of Matter (contribution/connection) is concretely delivered without over-promising — the design responsibility flagged in Statement 28.  **[PARTIAL -> Statements 27, 35, 36 | open: concrete external-pole mechanics now exist: mutual cord-healing (S27), world-growing branches (S35,36); 'without over-promising' remains a design caution]**
- Whether "the FIM cannot manufacture Matter alone" implies that some journeys *require* 1+1 or 1+community participation (i.e. certain mattering cannot be reached solo by design).  **[PARTIAL -> Statements 27, 36, 35 | open: relational requirement now structural - cord-healing/world-growth require connection (S27,36,35); whether specific journeys are gated to require it not explicitly stated]**
- How (and whether) Live / Grow / Matter is ever surfaced explicitly to FIMs, or whether — like the assessments dissolved into dialogue (Statement 18) — it stays beneath the surface as felt aspiration rather than stated doctrine.  **[PARTIAL -> Statement 28 | open: LGM positioned as the human-facing/aspirational layer, surfaceable in plain language (S28); whether stated as doctrine or kept felt not fully locked]**
- The precise scientific citations to stand behind the "informed by" claims when this graduates (SDT: Deci & Ryan; PERMA: Seligman; flow: Csikszentmihalyi; mattering: Rosenberg; meaning: Frankl; planned happenstance: Krumboltz; dichotomy of control: Epictetus) — to be verified and properly referenced at graduation, not asserted from memory.  **[STILL OPEN -> deferred per Statement 28]**
...
- Which Studio the **Anthropologist** uses (Statement 29): World Studio, a not-yet-named fourth Studio, or split across World and Arc? The one gap in the otherwise 1:1 role-to-Studio mapping.  **[RESOLVED -> Statement 30]**
- Whether the in-world role names should be register-consistent (Statement 29): coined/evocative (Dreamineer, Teller, Wayfinder) vs. plain titles (Creator, Anthropologist). Does "Anthropologist" (and "Creator") eventually want a FringeIsland-native name, or is the mix deliberate?  **[STILL OPEN -> deferred per Statement 29]**
- The full FIM-support mode family beyond Guide and Steward (Statement 29) — "probably many more roles." What is the complete set, and what does each care for?  **[STILL OPEN]**
- How a FIM *acquires* a Dreamineer authority (Statement 29) — earned through journeying? granted by Stewards/Universeers? application? A progression like Shadow→FIM (Statement 16)? The route into authorial mode is undefined.  **[PARTIAL -> Statement 29 | open: mechanism = group/role permission (S29); the acquisition route/criteria (earned/granted/applied) explicitly undefined]**
- How the in-world role language (Dreamineer, Teller, etc.) maps onto the existing *platform* role ladder (Member / Steward / Dreamineer / DeusEx) — reconciliation needed, since "Steward" and "Dreamineer" already appear in both vocabularies and may or may not mean the same thing.  **[PARTIAL -> Statement 29 | open: S29 establishes fiction-layer and platform-layer are one system seen two ways (major reconciliation); per-term exact mapping (Steward/Dreamineer) not fully drawn]**
- Whether Universeers and the Council are *required* to also be FIMs, or whether enterprise-stewardship can be held by non-members (Statement 29 assumes they ideally are FIMs, but it is not locked).  **[STILL OPEN -> deferred per Statement 29]**
- The internal structure of Universeers (five care-domains: constituency, portfolio, community, economy, legal) — are these five sub-roles, five committees, or one role with five concerns? And how the Council relates to the Universeers (oversight? overlap? distinct?).  **[STILL OPEN]**
- The inter-Studio **collaboration protocol** (Statement 30): who decides how much depth an NPC gets, and when? If a Teller needs a background villager to suddenly matter, do they reach back into World Studio to deepen an existing inhabitant, or author the new depth in Arc Studio? (Same seam as "who builds a person" under Statement 29.) A workflow/tooling decision downstream of the universe definition.  **[STILL OPEN -> deferred per Statement 30]**
- Whether the Anthropologist ever authors *named, specific* individuals (a historical founder, a living legendary figure of a culture), or whether every named specific human is always a Teller's job — i.e. exactly where the World/Arc line falls for special individuals. (Raised but not locked in Statement 30.)  **[PARTIAL -> Statement 30 | open: the general seam/intent-test is given (S30); the named-specific-individual edge case explicitly not locked]**
- How a being that needs to *act* (an NPC with behaviour, per Statement 15) draws on roles beyond body+culture+character — does dynamic behaviour pull in a Wayfinder or Teller, or is "behaviour" a fourth layer the model doesn't yet name?  **[PARTIAL -> Statement 30 | open: character layer (Teller) covers story-critical behaviour (S30); whether behaviour is a distinct fourth layer is an open refinement]**
