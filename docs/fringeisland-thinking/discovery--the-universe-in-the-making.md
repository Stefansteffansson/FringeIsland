...
- **Constant change is the steady state.** Experimentation, evaluation, and retirement of what doesn't work are continuous. FringeIsland is never "done".  **[2026-09-17 → OPEN: a founding stance (S13) written into none of VISION / MANIFESTO / PRINCIPLES-AI; the evolving way of working (PROCESS.md) is the nearest home]**
- **Humans and their stories outrank aesthetics and worldbuilding.** The world's visual style and "being" serve the humans inside it. Hierarchy: humans > stories > world.  **[2026-09-17 → OPEN: the humans > stories > world hierarchy is in none of the constitutional documents; MANIFESTO.md is its natural home]**
