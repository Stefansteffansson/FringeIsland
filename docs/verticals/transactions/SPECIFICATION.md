...
- **Q5 — Shadow transacting bounds.** A purchase is durable state plus payment PII; a Shadow is anonymous and ephemeral and holds neither (ADR-U027). The cold lean: Shadows cannot transact — transcendence to FIM is the purchase path. Held as a question because the U027 lifecycle owns its own open threads; this vertical does not resolve them. *Resolution point:* U027 transcendence/TTL design.
