...
**Carried out of the gate, filed not buried:** [`TASK-INT-03`](../backlog/tasks/TASK-INT-03-test-fixture-orphaned-personal-groups.md) (test fixtures orphan personal groups — 11 150 of 12 687 were orphaned, holding 73% of the notifications table; the universal blocker is fixed, two residual sources are not) and [`TASK-INT-04`](../backlog/tasks/TASK-INT-04-nd-pair-suppression-intermittent.md) (the N-D PAIR test is intermittent in fleet — **filed after an earlier "flake" call was retracted by a second failure**). ~~Also still open and non-blocking: **W-03**, **W-07**, **W-08**.~~ **All three CLOSED 2026-07-28** — see the [remediation ledger](./2026-07-27-antf-walk-findings.md). W-03 shipped in three parts (two surface, one at the emit site via migration `20260728190000`, held at the schema gate); W-07 took the house `refreshNavigation` convention; W-08 was one sentence with an empty referent.

**All three were then CONFIRMED ON THE DEPLOYED SITE at the [2026-07-30 re-walk](./2026-07-30-antf-rewalk-findings.md)**, along with W-04, W-05 and the NTF-9 degraded notice — the last of which no earlier walk could reach. That re-walk found four further defects (all fixed: PRs #331/#332) and left three items open by name: **ADM-8 sequencing**, 39 E2E groups in the DeusEx system group, and the `reconnecting…` label conflating a permission refusal with a transient drop. `TASK-INT-03` and `TASK-INT-04` are both **closed** (PR #330).
