...
**Date:** 2026-09-05 · **Status:** **CLOSED 2026-09-05.** Board settled the same day (Stefan: "go with the recommended rulings and start COR-E"; all nine rows as recommended); **#618** W1/W3/W4/W7 · **#619** W5/W8 · **#620** W6 · **#622** closure + doc-health merged fuller-auto; **#621** W2 (steering files + the session hook) merged on the named approval ("ok merge 621"). The front door now points at [the Ferd close](./2026-09-05-ferd-close-plan.md). Row 9 (leaked-password protection) stays open on the close's board — a dashboard setting, Stefan's. Execution record and DoD at the foot. Workstreams marked *fuller-auto* can run the moment the board settles; those marked *ask-first* are steering-file, ADR-index or deletion carve-outs and wait for Stefan's named nod per `AGENTS.md`.
