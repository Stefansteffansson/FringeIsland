...
**Status:** Living plan (v3, 2026-07-07). **Decision board SETTLED 2026-07-07** (Stefan — all answers recorded below; the two design sessions ran in-session and landed [ADR-U044](../../architecture/decisions/ADR-U044-journey-step-model.md) + [ADR-U045](../../architecture/decisions/ADR-U045-onboarding-journey.md)). **Cycle J-A CLOSED** (FEAT-PD002 ↔ FEAT-H019 + FEAT-PC016 rider, all `6-done`; J-O3 waterfall passed; [retro](../retrospectives/retro-2026-07-07.md)). **Cycle J-B DECOMPOSED 2026-07-07** ([FEAT-PD003](../../platform/domain/features/FEAT-PD003-journey-step-substrate-and-progress-contracts.md) ↔ [FEAT-H020](../../products/hub/features/FEAT-H020-journey-player.md), both `4-ready`; the ADR-U044 schema through the gate, the Q1 withdraw revisit on its Open-Q board). Next: build J-B.
