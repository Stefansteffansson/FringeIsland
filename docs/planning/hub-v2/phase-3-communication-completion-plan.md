...
- [ ] ADR-U043 measurement pass (cold ≥20-min idle ×3 + warm, tail rule) + Stefan's live walk — both before the area retro *(measurement half DONE 2026-07-21/22: warm all-PASS, three deep-cold windows run, W3 tail-FAIL dispositioned as labelled exception with the never-skip-the-pass rider — see the gate record; **live walk PENDING**)*
