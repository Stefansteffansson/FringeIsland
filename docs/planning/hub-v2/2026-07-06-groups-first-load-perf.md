...
3. ~~Perf budget~~ **Resolved — locked 2026-07-07 as [ADR-U043](../../architecture/decisions/ADR-U043-performance-budgets.md):** tiered budgets B1–B6 (sign-in flow target 2.0 s / ceiling 2.5 s with the ~1.0 s auth exchange named as vendor floor; warm ≤ 1 s; revisit no visible loading state; interactions ≤ 200 ms; skeleton-over-spinner rule) + the area-gate measurement protocol. Vetted against CWV / RAIL / Nielsen / SaaS practice in [`Performance_Budget_Research_Report.md`](../../fringeisland-thinking/research--engineering--performance-budget.md).
