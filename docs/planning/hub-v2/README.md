...
| 3 — Build area by area | Identity → Groups → Journeys → Communication → Notifications → Platform-Ops | **Active** (Identity: IDN-1..4 done; IDN-5..12 planned — see [`phase-3-identity-completion-plan.md`](./phase-3-identity-completion-plan.md)) |
