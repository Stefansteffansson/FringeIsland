...
| 3 — Build area by area | Identity → Groups → Journeys → Communication → Notifications → Platform-Ops | **Active** (Identity complete 2026-07-03 — IDN-12 parked, IDN-10 forward-seam; Groups kicking off — see [`phase-3-groups-completion-plan.md`](./phase-3-groups-completion-plan.md)) |
