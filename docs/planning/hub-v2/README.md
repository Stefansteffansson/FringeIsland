...
**Phases 0–4 are complete.** Phase 4 executed 2026-08-11/12 (exit checklist 7 of 9 at [2026-08-13](../sessions/2026-08-13_01_-_DM-01-GATE-EXECUTED-PHASE-4-CHECKLIST-TICKED.md); the two open items are the E2E smoke job in CI and the test tier leaving production, [ADR-U053](../../architecture/decisions/ADR-U053-test-tier-off-the-production-database.md)). **Live state lives in the most recent bridge under [`../sessions/`](../sessions/) and in the front door [`../cycles/cycle-current.md`](../cycles/cycle-current.md) — never in this paragraph.** (Audit V AC5-1, 2026-09-05: this README's hand-maintained status had stalled at "kicking off Notifications" for six weeks — the same wrong-layer pattern the Tracking section below names; the fix is pointer-not-snapshot.) **Next: the Ferd close** — `waves/ferd.md`, the wave DoD walk, the close retrospective — after [Cycle COR-E](./anatomy-correction-plan-cor-e.md). The phase history that used to live here is in the table below and in the per-phase documents it links.

**Parallel thread (not a phase): CQ-016 — the Hub's experiential trajectory.** Runs *alongside* this build, not inside it — it blocks nothing in Ferd (the experiential mechanisms land Eid+), so the walking skeleton and the early Phase-3 areas proceed independently. Two sizes (see [CQ-016](../../fringeisland-thinking/questions--ecosystem-open-questions.md)): a **framing slice** — does the DESCRIPTION convey the ambition, or undersell the Hub as a utility? — is runnable now in one focused session; the **full trajectory design** (wave-staging the experiential mechanisms) is multi-session and partly blocked, so it's deferred. **Coordination constraint:** the discovery's DESCRIPTION / §L3 / ROADMAP reconcile must land before Phase 3 reaches the experiential areas (Companion/Insight, Discovery) — a long runway, since those come last in the Phase-3 order.
...
| 3 — Build area by area | Identity → Groups → Journeys → Communication → Notifications → Platform-Ops | **Done** — Identity closed 2026-07-03 ([retro](../retrospectives/retro-2026-07-03.md)), Groups 2026-07-06, Journeys 2026-07-19 ([gate](./2026-07-19-journeys-area-gate.md)), Communication 2026-07-22 ([gate](./2026-07-21-communication-area-gate.md)), Notifications 2026-07-28 ([gate](./2026-07-27-notifications-area-gate.md)), Platform-Ops 2026-08-03 ([gate](./2026-08-02-platform-ops-area-gate.md)); the in-wave additions (ADM-E/F, HYG-A, ADM-G, N-E, RD-A/B/C) all shipped by 2026-08-09 ([bridge](../sessions/2026-08-09_02_-_RD-B-CLOSED-ALL-ELEVEN-FINDINGS-SETTLED-AND-MEASURED.md)); the AB-6 full anatomy audit ran 2026-08-10 ([record](./2026-08-10-ab6-full-anatomy-audit.md)) |
| 4 — Cutover & retire | Replace every area, then freeze and delete the old Hub | **Done** — executed 2026-08-11/12 ([plan](./phase-4-cutover-plan.md), board settled 2026-08-11): `hub-legacy/` deleted (W2, PR #502; tag `hub-legacy-final`, [discharge note](./2026-08-11-oracle-discharge-note.md)), root manifest tooling-only (W3, #503), deploy attestation (W4), the DB-free CI gate (W5, #496), docs pass + doc-health (W6, [record](./2026-08-13-phase-4-gate-doc-health.md)), DB reset + seeded ([bridge](../sessions/2026-08-12_01_-_PHASE-4-CLOSED-DB-RESET-SEEDED-TEARDOWN-COMPLIANT.md)). Exit checklist 7 of 9 at [2026-08-13](../sessions/2026-08-13_01_-_DM-01-GATE-EXECUTED-PHASE-4-CHECKLIST-TICKED.md); open: the E2E smoke job in CI (Stefan's ruling) and [ADR-U053](../../architecture/decisions/ADR-U053-test-tier-off-the-production-database.md) (Proposed) |
| Post-cutover (2026-08-13 → ) | The Ferd leftovers and hygiene before the close | **In progress** — the acting family (PD019/PD020, H046–H048) closed 2026-08-21 and walked green 2026-09-01; DBT-01/03, SEC-02, ANN-01, H017-01, JRN-PAUSE-01, SEAL-02 and DB-4 closed 2026-09-02/03 ([bridge](../sessions/2026-09-03_07_-_DB4-BUILT-GATE-APPLIED-ALL-FOUR-ITEMS-DONE.md)); the database review, the retention gate and ADR-U053 on 2026-09-05 ([bridge](../sessions/2026-09-05_01_-_CLEAN-SLATE-RETENTION-GATED-ADR-U053-PROPOSED.md)); Cycle COR-E closed the same day ([plan](./anatomy-correction-plan-cor-e.md), [audit V](../reference/ANATOMY-CONFORMANCE-AUDIT-5.md), PRs #615–#622); **now: the Ferd close** ([plan](./2026-09-05-ferd-close-plan.md)) — the front door `../cycles/cycle-current.md` is the live pointer |

*(Full detail with per-phase gates in Part 2 below. The Status column is closed history; current work is read from `../cycles/cycle-current.md` and the latest bridge, not from this table.)*
