...
- **Supabase drops the default table grants on 2026-10-30** — [TASK-SEC-03](../backlog/tasks/TASK-SEC-03-explicit-table-grants-before-supabase-drops-the-default-acl.md), Eid's second tooling item, built 2026-09-23 and held at the schema gate: the backfill migration, the static gate over the files, the presence cells, the rule. Lands before the first Eid table migration; a hard external date, not a disposition.
