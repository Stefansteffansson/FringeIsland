...
- **TASK-SEC-03 held at the schema gate** — Supabase drops the default table grants on 2026-10-30; "ok merge" after the gate commands in the [task](../backlog/tasks/TASK-SEC-03-explicit-table-grants-before-supabase-drops-the-default-acl.md)
