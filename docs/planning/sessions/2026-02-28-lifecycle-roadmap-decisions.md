...
- `docs/old_products/ferd/sessions/2026-02-28-lifecycle-roadmap-decisions.md` — This session bridge
...
- `docs/old_products/ferd/planning/ROADMAP.md` — Fixed stale links, added lifecycle roadmap reference
