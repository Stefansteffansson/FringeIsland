...
- `docs/old_products/ferd/sessions/2026-02-28-sprint3-smart-notifications.md` — This session bridge
...
- `CHANGELOG.md`, `PROJECT_STATUS.md`, `docs/old_products/ferd/planning/ROADMAP.md`, `docs/old_products/ferd/planning/LIFECYCLE_DECISIONS.md`
