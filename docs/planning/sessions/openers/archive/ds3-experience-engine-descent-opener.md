...
7. **Canonical cores (DS-3 has the broadest core surface of any descent so far):**
   - `docs/fringeisland-thinking/README.md` - journeys as the development vehicle (Who am I? What do I want? How do I get there?); growth gradient; signature-vs-charter personalisation.
   - `docs/fringeisland-thinking/canon--narrative--how-story-works.md` - the season/episode frame; respawn delivery as the experience half of the respawn sections; loop-is-the-medium.
   - `docs/fringeisland-thinking/canon--cosmology--worlds-topology.md` - sections 8 (anchoring/severance) and 10 (growth gradient = Void distance, not bodily distance); the access map; the tendable world journeys move through.
