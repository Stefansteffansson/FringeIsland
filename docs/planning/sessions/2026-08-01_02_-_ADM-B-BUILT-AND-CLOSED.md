...
- TASK-DOC-005 — platform-core CHANGELOG backfill (PC002–PC017 gap; register note in place) *(re-ID'd TASK-DOC-007 at ADM-C decomposition — ID collision)*
