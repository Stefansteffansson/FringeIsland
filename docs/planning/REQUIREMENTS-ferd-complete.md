...
**Analysis:**
- [ACTUAL_STATE.md](../ACTUAL_STATE.md) — Claude Code analysis (source of truth)

**Architecture:**
- [ARCHITECTURE_ANATOMY.md](../architecture/ARCHITECTURE_ANATOMY.md) — Layered model (L0-L7, V1-V5)
- [ARCHITECTURE_DECISIONS.md](../architecture/ARCHITECTURE_DECISIONS.md) — 24 locked ADRs
- [ARCHITECTURE_BASELINE.md](../architecture/ARCHITECTURE_BASELINE.md) — Live implementation state

**Planning:**
- [ROADMAP.md](ROADMAP.md) — Wave roadmap and milestones
- [SPRINT.md](../../SPRINT.md) — Active sprint tracker
- [DEFERRED_DECISIONS.md](DEFERRED_DECISIONS.md) — What we're NOT building yet
