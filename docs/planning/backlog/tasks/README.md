...
|---|---|---|---|
| [TASK-JC-01](./TASK-JC-01-pd004-red-first-integration-suite.md) — PD004 red-first integration suite | FEAT-PD004 | — | todo |
| [TASK-JC-02](./TASK-JC-02-pd004-completion-contracts-migration.md) — completion/timing contracts migration (schema gate) | FEAT-PD004 | JC-01 | todo |
