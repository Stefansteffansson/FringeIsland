...
None — between cycles. The previous cycle's files (TASK-JB-01..06) were swept when [`retro-2026-07-08.md`](../../retrospectives/retro-2026-07-08.md) committed, per the lifecycle above (TASK-JA-01..09 swept at [`retro-2026-07-07.md`](../../retrospectives/retro-2026-07-07.md)).
