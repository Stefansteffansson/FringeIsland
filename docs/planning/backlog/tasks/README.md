...
| [TASK-JC-02](./TASK-JC-02-pd004-completion-contracts-migration.md) — completion/timing contracts migration (schema gate) | FEAT-PD004 | JC-01 | done (gate nodded 2026-07-08 "yes to all"; applied; 88/88 + sweep 392/392) |
| [TASK-JC-03](./TASK-JC-03-h021-completion-moment-and-types.md) — completion moment + payload types | FEAT-H021 | JC-02 | done (+17 tests, 2026-07-08) |
| [TASK-JC-04](./TASK-JC-04-h021-review-mode-timing-entry-points.md) — review mode + timing + entry affordances | FEAT-H021 | JC-03 | done (+15 tests; unit 610/610, 2026-07-08) |
| [TASK-JC-05](./TASK-JC-05-h021-e2e-perf-close-out.md) — E2E + perf DoD + 6-done close-out | FEAT-H021 | JC-03, JC-04 | done (arc 1/1 + isolated re-run; siblings 4/4; build + lint green, 2026-07-08) |
