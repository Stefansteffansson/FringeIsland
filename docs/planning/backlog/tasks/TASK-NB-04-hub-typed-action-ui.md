...
## Acceptance criteria
- [x] STORY-1..4 unit tests (format/component/page tiers), demonstrated red-first.
- [x] `PendingNominations` component + `/groups` mount removed.
- [x] `GroupMembershipsPanel` acting Accept/Decline folded to read-only.
- [x] `next build` green; full unit suite green; route-policy conformance green.
