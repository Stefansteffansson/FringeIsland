...
**Links:** [Vision](../vision/VISION.md) | [Products & Platform](../vision/PRODUCTS_AND_PLATFORM.md) | [Product Spec](PRODUCT_SPEC.md) | [Sprint Tracker](../../SPRINT.md)

This document defines **WHEN** features are built and how the platform evolves. See [Products & Platform](../vision/PRODUCTS_AND_PLATFORM.md) for the authoritative product strategy and wave model. See [Product Spec](PRODUCT_SPEC.md) for **WHAT** and [Vision](../vision/VISION.md) for **WHY**. For current status, see [PROJECT_STATUS.md](../../PROJECT_STATUS.md). For version history, see [CHANGELOG.md](../../CHANGELOG.md).
...
See [Products & Platform](../vision/PRODUCTS_AND_PLATFORM.md) for full wave definitions, device strategy, and product family details.
...
**Conceptual foundation**: [Journey Designer Session 01](sessions/2026-03-20-JOURNEY_DESIGNER_SESSION.md) established the vocabulary, cosmology, and foundational data model concepts for the journey system. This is the prerequisite for all Hamn specification and implementation work.
...
See [DEFERRED_DECISIONS.md](DEFERRED_DECISIONS.md) for detailed rationale on what was deliberately deferred and when to revisit.
...
| Document | Purpose |
|----------|---------|
| [Products & Platform](../vision/PRODUCTS_AND_PLATFORM.md) | Authoritative product strategy and wave model |
| [Vision](../vision/VISION.md) | Why FringeIsland exists |
| [Manifesto](../vision/MANIFESTO.md) | Core values and principles |
| [Product Spec](PRODUCT_SPEC.md) | What we're building |
| [Architecture Anatomy](../architecture/ARCHITECTURE_ANATOMY.md) | L0-L7 layers, verticals, Platform API ring |
| [Architecture Baseline](../architecture/ARCHITECTURE_BASELINE.md) | Live implementation state mapped to anatomy |
| [Deferred Decisions](DEFERRED_DECISIONS.md) | What we chose not to build yet and why |
| [Journey Designer Session 01](sessions/2026-03-20-JOURNEY_DESIGNER_SESSION.md) | Foundational vocabulary and concepts for Hamn journey system |
| [Sprint Tracker](../../SPRINT.md) | Active sprint status |
| [Lifecycle Decisions](lifecycle-roadmap-decisions.md) | Binding decisions from lifecycle sprints |
