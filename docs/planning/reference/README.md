...
├── EMAIL-CHANGE-GAP-ANALYSIS.md           ← no path exists to change a member's email (2026-09-11); the five stores it touches, and a proposed ADR + two-spec plan. Decision board OPEN
