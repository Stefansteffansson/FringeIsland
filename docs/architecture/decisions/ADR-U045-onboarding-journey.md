...
- **What journey grain is open to Mists?** (DS-3 `journeys.md` §8 Q2 — open, deferred to the first-hour discovery work; the first hour is the Universe Bible's Open box S-14 in its story chapter, tracked as CQ-010, the universe's named highest-risk gap.)
