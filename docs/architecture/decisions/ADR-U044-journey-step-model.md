...
1. **The Journey Designer session (2026-03-20) enters the authority chain** for all journey-structure work, now and forward: DS-3's spec, the FEAT-PD/FEAT-H specs, and the Universe Bible's story chapter (whose Open box S-07 holds the route types and content families) reference it as the source design. Scope limit: this ADR adopts its **journey grammar** only — the session's *world* vocabulary predates the 2026-06 canon reconciliations (the Mist lifecycle, the worlds topology, the Whisp as the FIM's inner dialogue voice), so cosmology reads always defer to the Universe Bible (`docs/fringeisland-thinking/bible--fringeisland-universe.md`, which replaced the canon cores on 2026-09-26).
...
- Theory U research report ([`docs/fringeisland-thinking/research--growth--theory-u.md`](../../fringeisland-thinking/research--growth--theory-u.md)) — the documented real-world development-journey shape behind the design
