...
- **Related open questions:** [CQ-017](../../fringeisland-thinking/questions--ecosystem-open-questions.md) (this proposal's open-question home) · CQ-014 (Mist/visitor experience — the referral arrival is a new entry) · CQ-010 (the first hour — onboarding).
