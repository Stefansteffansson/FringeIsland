...
- Related: [ECOSYSTEM_ANATOMY_V4.svg](../ECOSYSTEM_ANATOMY_V4.svg) (the visual current at this ADR's writing; since superseded — the current diagram is indexed in [`../README.md`](../README.md))
