...
The addendum's evidence base moved twice within 24 hours ([analysis §7](../../planning/hub-v2/2026-07-09-cold-load-regression-analysis.md), [industry research](../../fringeisland-thinking/research--engineering--performance-budget-and-cold-start.md)):
