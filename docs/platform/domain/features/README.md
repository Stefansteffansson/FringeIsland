...
|----|-------|---------|------|----------|-----------|
| [FEAT-PD001](./FEAT-PD001-personal-journal-primitive.md) | Personal Journal primitive — private own-subject entry store with write/read/erasure/export contracts (IDN-5's platform half) | DS-7 Intelligence | Ferd | 4-ready | none |
