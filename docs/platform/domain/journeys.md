...
|---|---|---|---|
| Journey registry & route types (read side) · Enrolment lifecycle | [FEAT-PD002](./features/FEAT-PD002-journey-catalogue-and-enrolment-contracts.md) — journey catalogue & enrolment contracts | 5-in-cycle | Cycle J-A ([Journeys completion plan](../../planning/hub-v2/phase-3-journeys-completion-plan.md)); catalog/detail/my-enrolments reads, self- + group-enrolment, withdraw, the group enrolment-summary read, write-narrowing. Pairs with Hub [FEAT-H019](../../products/hub/features/FEAT-H019-journey-catalogue-and-enrolment.md). Route-type registry-ization deliberately deferred to the ADR-U044 pattern at a later FEAT-PD |
