...
- **The four areas:** Infrastructure (PC-1), Identity (PC-2), Organisation (PC-3), Governance (PC-4). All four area specifications exist as of PC-4 close (2026-05-15): [`infrastructure-specification.md`](./infrastructure-specification.md), [`identity-specification.md`](./identity-specification.md), [`organisation-specification.md`](./organisation-specification.md), [`governance-specification.md`](./governance-specification.md). Entity-level CLAUDE.md files exist for PC-3 ([`organisation/CLAUDE.md`](./organisation/CLAUDE.md)) and PC-4 ([`governance/CLAUDE.md`](./governance/CLAUDE.md)); PC-1 + PC-2 entity-level CLAUDE.md files are not yet authored (cascade policy in root [`CLAUDE.md`](../../../CLAUDE.md) applies — entity-level files exist where area-specific rules warrant a delta from this sub-tier file).
