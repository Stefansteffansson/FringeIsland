...
| [FEAT-PC003](./FEAT-PC003-self-service-profile.md) | Self-service profile — own-row read + identity-scope update contract — the platform half of IDN-4 | Identity (PC-2) | Ferd | 4-ready |
