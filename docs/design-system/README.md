...
When work begins, expect: tokens (colour, type, spacing), component contracts, accessibility rules (WCAG 2.1 AA), theming, motion, and the visual identity for the worlds (per the bible's worlds chapter, `../fringeisland-thinking/bible--fringeisland-universe.md`).
