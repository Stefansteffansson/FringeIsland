...
| `docs/fringeisland-thinking/canon--community--member-archetypes.md` | TASK-UNI-04 rulings D2 + D3 (2026-09-16) | `docs/fringeisland-thinking/` (before that `docs/ecosystem/universe/community/`) | The section "The member archetypes" of `canon--growth--engagement-spectrum.md` (Thinking grade carried on the section) |
