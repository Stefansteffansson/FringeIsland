...
| `docs/fringeisland-thinking/canon--growth--three-questions.md` (moved) and `canon--growth--engagement-spectrum.md` (deleted) | TASK-UNI-05 pass 4 (2026-09-16, Stefan's list) | `docs/fringeisland-thinking/` | Both are `bible--fringeisland-universe.md` — the three-questions file's history follows it (`git mv`); the spectrum and the archetypes are sections with their own grade lines |
