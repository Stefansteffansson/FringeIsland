...
<!-- RECORD GAP, found at the N-C close (2026-07-25): A-NTF Cycles N-A (2026-07-23,
     FEAT-PD013/FEAT-H030 — the passive bell, inbox and category registry) and N-B
     (2026-07-24, FEAT-PD014/FEAT-H031 — typed actions and acting fan-out) have no
     entries here; the changelog jumps from 2026-07-21 straight to this one. Both
     shipped and are recorded in their specs and session bridges. Flagged rather
     than back-filled from outside their cycles — routed to the A-NTF area gate. -->
