...
### Fixed — RD-B live walk (FEAT-H044 + FEAT-PC028 STORY-9), the notice-copy half held at the schema gate
...
- Unit **1403/1403** (170 suites) · lint 0 errors · `next build` green · the RD-B E2E 3/3. Migration `20260808120000` (three notice literals, `g.name` interpolated, fan-out unchanged) is **red-proven and held for a named approval**.
